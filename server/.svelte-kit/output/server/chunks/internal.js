import { H as HYDRATION_ERROR, g as get_descriptor, r as run_all, i as index_of, d as define_property, a as is_array, b as HYDRATION_START, c as HYDRATION_END, e as array_from, f as is_passive_event, h as render, p as push$1, s as setContext, j as pop$1 } from "./index2.js";
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\n<html lang="en">\n\n<head>\n    <meta charset="utf-8" />\n    <link rel="icon" href="' + assets2 + '/favicon.png" />\n    <meta name="viewport" content="width=device-width, initial-scale=1" />\n    ' + head + '\n</head>\n\n<body class="bg-base-50 text-text-50 dark:bg-base-300 dark:text-text-300" data-sveltekit-preload-data="hover">\n    <div style="display: contents">' + body + "</div>\n</body>\n\n</html>\n",
